...
export const demoAnswer: RagAnswer = {
  ...
  citations: [
    ...
    { sourceChunkId: "c_301", documentName: "Employee Handbook v3.1.pdf", chunkPosition: 301, excerpt: "Employee data retention follows the corporate schedule...", score: 0.81, coverage: "supporting", verificationNote: "Adds HR-specific retention schedules without driving the primary compliance answer.", sourceTextVerification: { status: "mismatch_detected", sourceChunkFullText: "Employee data retention policies are documented in the Data Retention Matrix maintained by People Operations, subject to compliance audit approval.", excerptFoundInSource: false, mismatchDetails: "Cited excerpt does not appear in source chunk. Source references a Matrix rather than inline schedules. Must retrieve the referenced Matrix document before this citation is release-ready.", reviewedBeforeRelease: true, reviewerAction: "Blocked from release; source document does not contain the excerpted text. Retrieve the referenced Data Retention Matrix for an accurate citation." } }
  ],
  confidence: "high",
